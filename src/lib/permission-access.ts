const PERMISSION_ALIASES: Record<string, string[]> = {
  ...
  'inventory.adjustment.reverse': ['inventory.adjustment.reverse', 'inventory.write', 'settings.manage'],
  ...
  'inventory.write_off.reverse': ['inventory.write_off.reverse', 'inventory.write', 'settings.manage'],
  'inventory.writeoff.reverse': ['inventory.writeoff.reverse', 'inventory.write_off.reverse', 'inventory.write', 'settings.manage'],
  'inventory.transfer.reverse_dispatch': ['inventory.transfer.reverse_dispatch', 'inventory.write', 'stock_transfer.approve', 'settings.manage'],
  'inventory.transfer.reverse_receipt': ['inventory.transfer.reverse_receipt', 'inventory.write', 'stock_transfer.approve', 'settings.manage'],
  ...
  'production_order.reopen': ['production_order.reopen', 'production.write', 'production_batch.close', 'settings.manage'],
