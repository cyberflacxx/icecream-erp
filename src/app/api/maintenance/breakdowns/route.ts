...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return apiServerError({
      ctx,
      error: err,
      message: 'Maintenance breakdowns could not be loaded.',
      module: 'maintenance.breakdowns',
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return apiServerError({
      ctx,
      error: err,
      message: 'The maintenance breakdown could not be recorded.',
      module: 'maintenance.breakdowns',
      path: request.nextUrl.pathname,
      status: 500,
      transactionReference: 'maintenance-breakdown-create',
    });
  }
}
